...
class CommandProcessor {
  ...
  async execute(cmd, args, source, sender) {
    switch (cmd) {
      ...
      case "help":
      case "commands": {
        return "📖 Commands: !pop, !time, !daynight, !oil [large|small|cargo|rf], !cargo, !clan, !pair [id name], !paired, !unpair <id>, !squad <name>, !setsquad <p> <s>, !team, !teamalert [h], !locate <name>, !lockdown [on/off], !raidcost <targets>, !boom, !sulfur, !armory, !multitc, !cams [monument], !motd, !turrets on/off, !sams on/off, !doors on/off, !craft <qty> <item>, !recycle <item>, !ai <msg>, !status";
      }
