...
class AIAssistant {
  ...
  buildSystemContext() {
    ...
    if (this.rustClient.storageTracker) {
      ...
      armoryInfo = `${arm.rockets}x Rockets, ${arm.c4}x C4, ${arm.satchels}x Satchels, ${arm.explo}x Explo 5.56 | Total Raid Sulfur Potential: ${arm.totalRaidSulfur.toLocaleString()} Sulfur`;
    }
